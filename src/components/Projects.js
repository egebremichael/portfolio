...
import curlyvid from './images/curly-demo.mov';
import appyo from './images/appyo-demo.mov';
import heber from './images/heber.png';
import asos from './images/asos.png';

const projects = [
  { id: 1, title: 'The Curl Guidance', shortDescription: 'A tool for curl care and guidance.', link: '#', github: 'https://github.com/egebremichael/Curly-hair-product-recommender', website: 'https://curly-hair-product-recommender.vercel.app/', video: curlyvid, technologies: ['Python', 'CSS', 'JavaScript'], moreDescription: 'The website provides a tailored approach to curly hair care, featuring an interactive quiz that assesses users\' specific hair needs and preferences. It delivers personalized product recommendations from a database of hundreds of carefully researched items, with recommendations based on hair type, texture, composition, and specific concerns such as frizz or hydration. Built using HTML, JavaScript, and CSS, the site combines a modern design with functional features to provide an engaging and user-friendly experience.'},
  { id: 2, title: 'ASOS Influencer Recommender', shortDescription: 'AI-based influencer recommendation system.', link: '#', github: 'https://github.com/egebremichael/influencer-recommender-ml', image: asos, technologies: ['React', 'CSS', 'HTML'], moreDescription: 'InstaMatch is a sophisticated machine learning-driven influencer recommendation system designed to optimize marketing for apparel brands like ASOS. The structure of ASOS’s API matches the ideal API structure of IBM Research AI for Fashion, making the platform adaptable for other brands. It uses Multimodal Post Attentive Profiling and Natural Language Processing to analyze influencer content and audience interactions, providing recommendations based on influencer categories such as celebrities, micro-influencers, and niche creators, determined by their follower count. Powered by PySpark for scalable data processing and TensorFlow for advanced analytics, this project includes a research paper that details how InstaMatch was refined through rigorous testing of various machine learning models to achieve optimal accuracy. The paper also compares its performance with existing models, highlighting its notable innovations and contributions to the field.' },
  { id: 3, title: 'Scot Central', shortDescription: 'A community hub for local news.', link: '#', github: 'https://github.com/egebremichael/College_app', video: JIS, technologies: ['Node.js', 'HTML'], moreDescription: 'Leveraging Flutter for cross-platform functionality, this app supports over 2,000 College of Wooster students with real-time shuttle tracking and up-to-date dining information. Integrated with Firebase for secure authentication and Google Maps API for precise location services, it simplifies campus navigation and access.' },
  { id: 4, title: 'Heber Flowers and Decor', shortDescription: 'A floral arrangement and decor service.', link: '#', github: 'https://github.com/egebremichael/heber-decor-webpage', website: 'heberflowers.com', image: heber, technologies: ['Python', 'JavaScript'], moreDescription: 'The website offers a comprehensive solution for a flower shop, enabling customers to browse and order flowers and related gifts online. It features options to schedule services for events such as weddings, birthdays, and anniversaries. Customers can also contact the store and request additional information through integrated forms. Crafted with React, the site provides a dynamic and intuitive interface, enhancing the online shopping experience and simplifying service arrangements.' },
  { id: 5, title: 'Appyo', shortDescription: 'A productivity app for managing tasks.', link: '#', website: 'https://www.appyyo.com', video: appyo, technologies: ['CSS', 'JavaScript'], moreDescription: 'The Appy.Yo website is a comprehensive platform for the tech consulting company, featuring detailed information on their services, package pricing, and company background. It also highlights recent projects to showcase the firm’s expertise. Developed with Angular, the site combines a modern, interactive design with user-friendly navigation, effectively presenting the company’s offerings and engaging potential clients.'},
  { id: 6, title: 'Book Avenue', shortDescription: 'A platform for book lovers.', link: '#', github: 'https://github.com/egebremichael/Library_system', image: library, technologies: ['React', 'Node.js'], moreDescription: 'Developed with Python and Flask, this system manages over 10,000 books, improving librarian efficiency and user experience. Features include account creation, customizable borrowing durations, and the ability to return books early for new ones. Utilizing MySQL for data management and HTML/JavaScript for the user interface, it enhances library operations and book management.'},
  { id: 7, title: 'Project Seven', shortDescription: 'Description for project seven.', link: '#', image: library, technologies: ['HTML', 'CSS'], moreDescription: 'Detailed description for Project Seven.'},
];
